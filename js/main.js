...
// let btn = document.querySelector('#btn') // возвращает только первый найденный элемент
...
// container.innerText = '<h1>Hello DOM!</h1>'  //передается только текст
// container.innerHTML = '<h1>Hello DOM!</h1>' // передается вёрстка
